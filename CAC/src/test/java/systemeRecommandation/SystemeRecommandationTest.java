...
public class SystemeRecommandationTest {
    ...
    public void setUp() {
        ...
        portsRequis = Arrays.asList(
                new Port(UUID.randomUUID(), composants.get(0), "s0"),
                new Port(UUID.randomUUID(), composants.get(0), "s1"),
                new Port(UUID.randomUUID(), composants.get(1), "s2"),
                new Port(UUID.randomUUID(), composants.get(2), "s0"),
                new Port(UUID.randomUUID(), composants.get(2), "s2"),
                new Port(UUID.randomUUID(), composants.get(3), "s3")
        );

        portsFournis = Arrays.asList(
                new Port(UUID.randomUUID(), composants.get(0), "s2"),
                new Port(UUID.randomUUID(), composants.get(1), "s1"),
                new Port(UUID.randomUUID(), composants.get(2), "s1"),
                new Port(UUID.randomUUID(), composants.get(2), "s3"),
                new Port(UUID.randomUUID(), composants.get(3), "s0"),
                new Port(UUID.randomUUID(), composants.get(3), "s2")
        );
    }
    ...
    public void testCalculValeurInteretOK() {
        // Given
        Connexion connexion = new Connexion(UUID.randomUUID(), portsFournis.get(0), portsRequis.get(1), 10, null);
        int valeurInteret;
    ...
    public void testCreerConfigurations() {
        ...
        List<Connexion> connexions = Arrays.asList(
                // s0
                new Connexion(UUID.randomUUID(), portsFournis.get(4), portsRequis.get(0), 100, 75),
                new Connexion(UUID.randomUUID(), portsFournis.get(4), portsRequis.get(3), 100 ,90),

                // s1
                new Connexion(UUID.randomUUID(), portsFournis.get(1), portsRequis.get(1), 100, 100),
                new Connexion(UUID.randomUUID(), portsFournis.get(2), portsRequis.get(1), 100, 90),

                // s2
                new Connexion(UUID.randomUUID(), portsFournis.get(0), portsRequis.get(2), 100, 90),
                new Connexion(UUID.randomUUID(), portsFournis.get(0), portsRequis.get(4), 100, 80),
                new Connexion(UUID.randomUUID(), portsFournis.get(5), portsRequis.get(2), 100, 70),
                new Connexion(UUID.randomUUID(), portsFournis.get(5), portsRequis.get(4), 100, 60),

                // s3
                new Connexion(UUID.randomUUID(), portsFournis.get(3), portsRequis.get(5), 100, 100)
        );
